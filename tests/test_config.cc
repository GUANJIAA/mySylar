/*
 * @Author: GUANJIAA
 * @Date: 2023-06-04 11:23:16
 * @LastEditTime: 2023-06-11 15:03:12
...
sylar::ConfigVar<std::unordered_set<int>>::ptr g_int_unordered_set_value_config = sylar::Config::Lookup("system.int_unordered_set", std::unordered_set<int>{1, 2}, "system int unordered_set");

sylar::ConfigVar<std::map<std::string, int>>::ptr g_int_map_value_config = sylar::Config::Lookup("system.int_map", std::map<std::string, int>{{"k", 2}}, "system int map");

sylar::ConfigVar<std::unordered_map<std::string, int>>::ptr g_int_unordered_map_value_config = sylar::Config::Lookup("system.int_unordered_map", std::unordered_map<std::string, int>{{"k", 2}}, "system int unordered_map");
...
#define XX_M(g_var, name, prefix)                                                                             \
    ...
    YAML::Node root = YAML::LoadFile("/root/projects/sylar/bin/conf/log.yml");
...
#define XX_PM(g_var, prefix)                                                                                \
    ...
    SYLAR_LOG_INFO(SYLAR_LOG_ROOT()) << "begore: " << g_person_vec_map->toString();

    YAML::Node root = YAML::LoadFile("/root/projects/sylar/bin/conf/test.yml");
    sylar::Config::LoadFromYaml(root);
